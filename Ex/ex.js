...
// 	}
// }
// console.log(search_id(51));

// function search_email(key){
// 	for(let i = 0; i < users.length ; i++) {
// 		let full_name = (users[i].first_name + users[i].last_name).toLowerCase();
// 		full_name.includes(key);
// 		console.log(full_name.includes(key));
// 		if(full_name.includes(key) === true) {
// 			return users[i].email;
// 		}
// 	}
// }
// console.log(search_email('lem'));
...
// 		}
// 	}
// 	return 'Số user trên 50 tuổi : ' + count;
// }
// console.log(count_age());


// function status_marries(){
// 	let married = 0;
// 	let not_married =0;
// 	for(let i = 0; i < users.length; i++) {
// 		if(users[i].is_married === true){
// 			married++;
// 		}else if(users[i].is_married === false){
// 			not_married++;
// 		}
// 	}
// 	return 'Số user đã kết hôn là : ' + married + '\nSố user chưa kết hôn là : '+ not_married;
// }
// console.log(status_marries());
...
// 	let count = {};
// 	for(let i = 0; i < users.length; i++){
// 		while (job_arr.includes(users[i].job) === false){
// 			job_arr.push(users[i].job);
// 		}
// 	}
// 	for(let j = 0; j < job_arr.length; j++){
// 		if(job_arr[j].includes(' ') === true){
// 			let new_string =  job_arr[j].replace(" ","_");
// 			job_arr[j] = new_string;
// 		}
// 		count[job_arr[j]] = 0;
// 	}
// 	for(let a = 0; a < users.length; a++){
// 		for(let key in count){
// 			if(users[a].job.replace(" ","_") === key){
// 				count[key] ++;
// 			}
// 		}
// 	}
